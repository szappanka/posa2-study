...
- [Event Handling]({{ '/docs/06-event-handling-overview' | relative_url }})
- [Synchronization]({{ '/docs/11-synchronization-overview' | relative_url }})
- [Concurrency]({{ '/docs/16-concurrency-overview' | relative_url }})

---

## Kutatási kapcsolódás
